                                ...
                                <div class="row align-items-center slider-animated-1">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="hero-slider-content-2">
                                            ...
                                            <h3 class="animated fw-900">Diskon ekstra</h3>
                                            <h2 class="animated fw-900 text-brand">Penawaran eksklusif.</h2>
                                            <p class="animated"> #DiskonSupermarket #BelanjaHemat</p>
                                            <a class="animated btn btn-brush btn-brush-3"
                                                href="#" tabindex="0"> Ayo Belanja! </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                                        <div class="single-slider-img single-slider-img-1">
                                            <img class="animated"
                                                src="{{ asset('evara') }}/assets/imgs/slider/rak2.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center slider-animated-1">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="hero-slider-content-2">
                                            ...
                                            <h3 class="animated fw-900"> Belanja sekarang!</h3>
                                            <h2 class="animated fw-900 text-brand">Diskon 30%</h2>
                                            <p class="animated">untuk semua produk sayuran organik.</p>
                                            <a class="animated btn btn-brush btn-brush-1"
                                                href="#" tabindex="0"> Belanja yuk! </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-7 col-md-6">
                                        <div class="single-slider-img single-slider-img-1">
                                            <img class="animated"
                                                src="{{ asset('evara') }}/assets/imgs/slider/rak-buah1.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow fadeIn animated">
                            <img src="{{ asset('evara') }}/assets/imgs/banner/bener1.png" alt="">
                            <div class="banner-text">
                                <span>Smart Offer</span>
                                <h4>Save 20% on <br>Vegetables</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="banner-img wow fadeIn mb-45mb-lg-0 animated d-lg-block d-none">
                            <img src="{{ asset('evara') }}/assets/imgs/banner/bener11.png" alt="">
                            <div class="banner-text">
                                <span>Women Zone</span>
                                <h4>Save 17% on <br>Fruits</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
