                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form action="{{ route('data.data_petugas.store') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Nama Panjang<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Masukan Nama Panjang..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
